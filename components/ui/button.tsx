...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 overflow-hidden rounded-[18px] border text-sm font-semibold tracking-[0.01em] transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-ring)] disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          "border-[color:var(--color-border)] bg-white/78 px-5 py-2.5 text-[var(--color-ink)] shadow-[0_12px_30px_rgba(68,55,48,0.07)] hover:-translate-y-0.5 hover:border-[color:var(--color-border-strong)] hover:bg-white",
        ghost:
